...
function MyNavbar(props) {
  ...
  return (
    <Navbar className="navflex" bg="light" expand="lg">
      <Container fluid>
        <Navbar.Brand href="/">
          <img className="logo" src="/linkedinlogo.png" alt="linkedin logo" />
        </Navbar.Brand>
        ...
        <Navbar.Collapse id="navbarScroll">
          ...
          >
            ...
            >
              <img className="navicon" src="/icons8-home.svg" alt="Home" />
              Home
            </Nav.Link>
            <Nav.Link
            ...
            >
              <img className="navicon" src="/bell-svgrepo-com.svg" alt="Home" />
              Notifications
            </Nav.Link>

            <div className="naviconflex">
              <img className="navpicture" src={localUser?.image} alt="pfpic" />
              <NavDropdown title="Me" id="navbarScrollingDropdown">
                ...
                >
                  <div className="smallerdropdownflex">
                    ...
                    />{" "}
                    <div>
                      <p className="dropdownname">{localUser?.name}</p>{" "}
                      <p>{localUser?.title}</p>{" "}
                    </div>
                  </div>
                ...
                <NavDropdown.Divider />
                <NavDropdown.Item href="#action8" onClick={props.logout}>
                  Sign out
                </NavDropdown.Item>
              </NavDropdown>
            </div>
